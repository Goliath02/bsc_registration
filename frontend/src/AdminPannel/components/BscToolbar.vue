...
<template>
	<!-- Mobile App Bar -->
	<div v-if="isMobile" class="left-0 right-0 bg-surface-900 text-surface-0 h-16 py-2 flex items-center px-4 z-50 sticky top-0">
			...
			<template #container="{ closeCallback }">
				<div class="flex flex-col h-full">
					<div class="flex items-center justify-between px-6 pt-4 shrink-0">
						...
						<span>
                            <Button type="button" @click="closeCallback" icon="pi pi-times" class="!bg-white !border-white"
                                    rounded></Button>
                        </span>
					</div>
