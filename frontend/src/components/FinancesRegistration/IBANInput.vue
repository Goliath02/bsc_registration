...
watch(
    [IBANSection1, IBANSection2, IBANSection3, IBANSection4, IBANSection5, IBANSection6],
    updateIBAN
);
...
<template>
	...
	<div class="flex gap-[1em] max-[1024px]:gap-[0.5em]">
		<input :ref="inputRefs[0]" v-model="IBANSection1"
		...
		>
		<input :ref="inputRefs[1]" v-model="IBANSection2"
		       class="w-full flex-2 h-[3em] lg:px-[0.5em]  bg-[#09090b] border border-[#71717a] rounded-lg font-medium appearance-none text-center"
		       data-index="2"
		       maxlength="4"
		       @input="onIbanInput($event,4)"
		>
		<input :ref="inputRefs[2]" v-model="IBANSection3"
		       class="w-full flex-2 h-[3em] lg:px-[0.5em]  bg-[#09090b] border border-[#71717a] rounded-lg font-medium appearance-none text-center"
		       data-index="3"
		       maxlength="4"
		       @input="onIbanInput($event,4)"
		>
		<input :ref="inputRefs[3]" v-model="IBANSection4"
		       class="w-full flex-2 h-[3em] lg:px-[0.5em]  bg-[#09090b] border border-[#71717a] rounded-lg font-medium appearance-none text-center"
		       data-index="4"
		       maxlength="4"
		       @input="onIbanInput($event,4)"
		>
		<input :ref="inputRefs[4]" v-model="IBANSection5"
		       class="w-full flex-2 h-[3em] lg:px-[0.5em]  bg-[#09090b] border border-[#71717a] rounded-lg font-medium appearance-none text-center"
		       data-index="5"
		       maxlength="4"
		       @input="onIbanInput($event,4)"
		...
		<input :ref="inputRefs[5]" v-model="IBANSection6"
