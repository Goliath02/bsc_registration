package bsc_registration.features.auth.config;

import bsc_registration.features.auth.filter.JwtAuthFilter;
import bsc_registration.features.auth.filter.LoginRateFilter;
		...
		return http
				...
				.authorizeHttpRequests(authorizeRequests ->
						authorizeRequests.requestMatchers("/", "/courses", "/priceList", "/registrate", "/registrateNsw", "/api/auth/login",
								...
								.requestMatchers( "/api/auth/key/create", "/api/trainers/**", "/api/invites/**", "/api/mail/send", "/api/mail/sendAll", "/api/mail/**")
								.hasAuthority("ADMIN")
