package bsc_registration.features.registration.service;
...
import bsc_registration.features.course.config.BscCourseConfig;
import bsc_registration.features.config.ConfigLoader;
import bsc_registration.features.auth.repository.BscMemberRepository;
import bsc_registration.features.registration.repository.NswRegistrationRepository;
